    ...
    var html = _.template([
      '<table class="table">',
        '<tr>',
          ...
          '<th class="text-center">Kilocaloriën</th>',
          '<th class="text-center">Koolhydraten</th>',
          '<th class="text-center">Eiwitten </th>',
          '<th class="text-center">Vetten</th>',
        '</tr>',
        '<% _.each(ingredients, function(ingredient, idx) { %>',
          '<tr>',
            '<td><%= ingredient.name %></td>',
            '<td class="text-center"><%= amounts[idx].toFixed(2) %></td>',
        ...
        '<% }); %>',
        '<tr>',
          '<td style="border-top: 1px solid #888">Totaal</td>',
